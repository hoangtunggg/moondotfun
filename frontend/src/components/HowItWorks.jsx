  ...
  return (
    <div style={styles.fullPage}>
      <div style={styles.content}>
        ...
        <p style={styles.paragraph}>
          All coins created on Pump are <strong>fair-launch</strong>, meaning there are no pre-mines, no special allocations, and no early advantages.
          Everyone participates equally from the very beginning.
        </p>
        <ul style={styles.list}>
          <li><strong>Step 1:</strong> Pick a coin that you like or create your own.</li>
          <li><strong>Step 2:</strong> Buy the coin via bonding curve. The earlier you buy, the cheaper it is.</li>
          <li><strong>Step 3:</strong> Sell anytime to realize your profits (or losses).</li>
          <li><strong>Step 4:</strong> Engage with the community. Share memes, hype your project, and grow organically.</li>
          <li><strong>Step 5:</strong> Track performance in real-time and climb the leaderboard!</li>
        </ul>
        <p style={styles.paragraph}>
